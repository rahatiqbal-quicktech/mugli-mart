...
class Sellerinfo {
  ...
  String? shopbanner;
  int? sellerphone;
  dynamic sellerphone2;
  String? selleremail;
  dynamic contperson;
  dynamic sellercash;
  dynamic sellerwithdraw;
  dynamic selleraddress;
  dynamic sellerwebsite;
  String? sellerbkashaccount;
  String? sellerrocketaccount;
  String? sellernagodaccount;
  dynamic sellerbankaccount;
  dynamic sellerbankname;
  dynamic sellerbankbranch;
  dynamic sellerroutingno;
  dynamic publishproduct;
  dynamic commisiontype;
  dynamic commision;
  dynamic featurevandor;
  int? agree;
  int? verify;
  dynamic forgetcode;
  int? status;
